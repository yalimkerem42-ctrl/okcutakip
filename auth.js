...
//  YARDIMCILAR
// ────────────────────────────────────────────────────────────────────
function toast(msg, type, duration) { if (typeof window.showToast === "function") window.showToast(msg, type, duration); }
...
async function authRegister() {
  ...
  try {
    ...
    try {
      ...
      toast("📧 Doğrulama bağlantısı e-posta adresinize gönderildi. Gelen kutunuzda görünmüyorsa lütfen Spam / Gereksiz Posta klasörünü kontrol edin.", "success", 6000);
    } catch (ve) {
